...
OUTPUT_ROOT="${OUTPUT_ROOT_OVERRIDE:-/mnt/taurus/data1/jiaxuanluo/speech_llm_zh_cap16_denoise_budget_20260526}"
LOG_ROOT="${LOG_ROOT_OVERRIDE:-/mnt/taurus/data1/jiaxuanluo/logs/zh_cap16_denoise_budget_ttag_20260526T0437}"
...
CAP16_BUILDER="${ROOT_DIR}/slm/data_prep/launchers/20260525__build_deja_termmap_ablation_cap16_exactboundary.sh"
...
df -h /mnt/gemini/data1 /mnt/taurus/data1 || true
