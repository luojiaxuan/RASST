...
NOTES_FILE="${NOTES_FILE_OVERRIDE:-/mnt/taurus/data2/jiaxuanluo/RASST/docs/provenance/slm/20260525__speech_llm_de_cap16_denoise_budget_ttag_r32a32_ep1_taurus6.md}"
...
HF_EXPORT_STAGE_ROOT="${HF_EXPORT_STAGE_ROOT_OVERRIDE:-/mnt/taurus/data1/jiaxuanluo/hf_export_stage/speech_llm_de_cap16_denoise_budget_ttag_${RANK_TAG}_ep1_taurus6}"
HF_EXPORT_MIN_FREE_GB="${HF_EXPORT_MIN_FREE_GB_OVERRIDE:-90}"
HF_EXPORT_LOCAL_CACHE_ROOT="${HF_EXPORT_LOCAL_CACHE_ROOT_OVERRIDE:-/mnt/taurus/data1/jiaxuanluo/slm_cache/speech_llm_de_cap16_denoise_budget_ttag_${RANK_TAG}_ep1_taurus6/keep1.0_r32}"
HF_EXPORT_LOCAL_LATEST_LINK="${HF_EXPORT_LOCAL_LATEST_LINK_OVERRIDE:-/mnt/taurus/data1/jiaxuanluo/slm_cache/speech_llm_de_cap16_denoise_budget_ttag_${RANK_TAG}_ep1_taurus6/latest-hf}"
