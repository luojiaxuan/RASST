...
LANG_CODE="zh"
DATA_DIR="${DATA_DIR_OVERRIDE:-/mnt/taurus/data1/jiaxuanluo/speech_llm_zh_cap16_denoise_budget_20260526/zh/hn1024_tau078_cap16_denoise_budget_ttag_v1}"
...
NOTES_FILE="${NOTES_FILE_OVERRIDE:-/mnt/taurus/data2/jiaxuanluo/RASST/docs/provenance/slm/20260526__speech_llm_zh_cap16_denoise_budget_ttag_r32a32_ep1_taurus4.md}"

LORA_RANK="${LORA_RANK_OVERRIDE:-32}"
LORA_ALPHA="${LORA_ALPHA_OVERRIDE:-32}"
RANK_TAG="r${LORA_RANK}a${LORA_ALPHA}"
SAVE_BASE="${SAVE_BASE_OVERRIDE:-/mnt/taurus/data1/jiaxuanluo/slm/speech_llm_zh_cap16_denoise_budget_ttag_${RANK_TAG}_ep1_taurus4}"
TRAIN_LOG_DIR="${TRAIN_LOG_DIR_OVERRIDE:-/mnt/taurus/data1/jiaxuanluo/logs/speech_llm_zh_cap16_denoise_budget_ttag_${RANK_TAG}_ep1_taurus4}"
HF_EXPORT_STAGE_ROOT="${HF_EXPORT_STAGE_ROOT_OVERRIDE:-/mnt/taurus/data1/jiaxuanluo/slm_local_cache/hf_export_stage/speech_llm_zh_cap16_denoise_budget_ttag_${RANK_TAG}_ep1_taurus4}"
HF_EXPORT_MIN_FREE_GB="${HF_EXPORT_MIN_FREE_GB_OVERRIDE:-90}"
HF_EXPORT_LOCAL_CACHE_ROOT="${HF_EXPORT_LOCAL_CACHE_ROOT_OVERRIDE:-/mnt/taurus/data1/jiaxuanluo/slm_local_cache/speech_llm_zh_cap16_denoise_budget_ttag_${RANK_TAG}_ep1_taurus4/keep1.0_r32}"
HF_EXPORT_LOCAL_LATEST_LINK="${HF_EXPORT_LOCAL_LATEST_LINK_OVERRIDE:-/mnt/taurus/data1/jiaxuanluo/slm_local_cache/speech_llm_zh_cap16_denoise_budget_ttag_${RANK_TAG}_ep1_taurus4/latest-hf}"
...
df -h /mnt/taurus/data1 /mnt/gemini/data1 /mnt/gemini/data2 || true
