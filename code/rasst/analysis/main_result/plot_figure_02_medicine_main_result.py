#!/usr/bin/env python3
"""Plot paper Figure 2 from this package's frozen TSV snapshot."""
...
DEFAULT_PREFIX = SCRIPT_DIR / "medicine_main_result"
...
def main() -> int:
    ...
    if args.update_paper:
        ...
        shutil.copy2(args.out_prefix.with_suffix(".pdf"), figure_dir / "medicine_main_result.pdf")
        shutil.copy2(args.out_prefix.with_suffix(".png"), figure_dir / "medicine_main_result.png")
        print(f"updated {figure_dir / 'medicine_main_result.pdf'}")
        print(f"updated {figure_dir / 'medicine_main_result.png'}")
    return 0
